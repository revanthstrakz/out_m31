...
import (
	...
	pkg "android/soong/genrule"
)

var t = []testing.InternalTest{

	{"TestGenSrcs", pkg.TestGenSrcs},

	{"TestGenruleCmd", pkg.TestGenruleCmd},

	{"TestGenruleDefaults", pkg.TestGenruleDefaults},
