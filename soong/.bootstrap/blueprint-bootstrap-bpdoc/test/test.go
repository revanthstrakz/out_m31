...
import (
	...
	pkg "github.com/google/blueprint/bootstrap/bpdoc"
)

var t = []testing.InternalTest{

	{"TestFuncToPkgPath", pkg.TestFuncToPkgPath},

	{"TestModuleTypeDocs", pkg.TestModuleTypeDocs},

	{"TestPackage", pkg.TestPackage},

	{"TestPropertyStruct", pkg.TestPropertyStruct},
...
func (matchString) ImportPath() string {
	return "github.com/google/blueprint/bootstrap/bpdoc"
}
